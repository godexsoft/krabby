...
class log
{
  ...
  public:
    ...
    template <typename... Args> static void trace(const char *format, const Args &... args)
    {
  ...
  private:
    ...
    template <typename... Args> void dump(loglevel level, const char *format, const Args &... args)
    {

...
public:
	...
	void delet(std::string regex, std::set<std::string> mandatory_fields, route_t handler);
	void delet(std::string regex, route_t handler, fields_t mandatory_fields = {});

	void put(std::string regex, std::set<std::string> mandatory_fields, route_t handler);
	void put(std::string regex, route_t handler, fields_t mandatory_fields = {});

	void patch(std::string regex, std::set<std::string> mandatory_fields, route_t handler);
	void patch(std::string regex, route_t handler, fields_t mandatory_fields = {});
